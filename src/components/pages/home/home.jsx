            ...
            <div className="container">
                ...
                <div className="home_genres ">
                    ...
                    <div className="home_generes_element JC_s-a">
                        <div className="card">
                            <img src="https://s3-alpha-sig.figma.com/img/e19f/df0f/d8e5c0ec1ac052ee2b8b58e6ba7aefd7?Expires=1708300800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=EXfqgn0zkMZPZANQPyAaGe4S2gmUmzEhhhT2xyHAf8w6bCsKZkSnciyI-t6tztfSaWjKg59g1PrRH1b3cOL9JmbqIkIbd8O9RJyTuMl9ERCvMfqyWOxUCC452JAK6~Hxi0dMxDggujC5fXvuHqCJ-DCrEQZyz6h9bpPUVNmeplBxqrLBQuzIbAOf4tVn1WQHsmGFMP4OTAQdxA82aLP-2~FgXiPsCJAr1pUw5rdeHIgY3wdU-TiaZy8df8ztitYbBctsmwt7j7VYmfmgrAiu0qMBVdnLDB5Me8Hz9sx2BIONW3DeRvwDxLC0WhKM3UJQzdkTEBrt6MWWDylYvl2RFg__" alt="" />
                            <h2>Sci-Fi</h2>
                        </div>
                        <div className="card">
                            <img src="https://nztcdn.com/files/b14cc276-6590-4f05-9b17-523508788f00.webp" alt="" />
                            <h2>For-kids</h2>
                        </div>
                        <div className="card">
                            <img src="https://nztcdn.com/files/d5ead12a-1c64-4d7d-8024-223c9b88b167.webp" alt="" />
                            <h2>Psychology</h2>
                        </div>
                        <div className="card">
                            <img src="https://nztcdn.com/files/bc3e9a8a-3fdc-455e-8554-298d30193340.webp" alt="" />
                            <h2>Romantic</h2>
                        </div>
                        <div className="card">
                            <img src="https://nztcdn.com/files/f8caa974-4b20-44a4-8f9f-fe516ac748b0.webp" alt="" />
                            <h2>Detective</h2>
                        </div>
                        <div className="card">
                            <img src="https://nztcdn.com/files/ad4e2e5f-1e72-4424-ba44-b7a40b814908.webp" alt="" />
                            <h2>Finance</h2>
                        </div>
                    </div>
                </div>
